...
class UsuariosModel extends Query{
    ...
    public function registraUsuario($nombreParam, $idParam) {}
    public function modificaUsuario($nombreParam, $idParam) {}
    public function actualizaEstado($idParam, $estadoParam) {}
    public function actualizaClave($idParam, $nuevaClave) {}
}
?>